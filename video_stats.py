...
def get_videosId(playlistId):
    videos_ids = []
    pageToken = None
    base_url = f"https://youtube.googleapis.com/youtube/v3/playlistItems?part=contentDetails&maxResults={maxResults}&playlistId=UU52YgT6TITyBpck82V_N_8g&key={API_KEY}" 
    try:
        while True:
            url = base_url
            if pageToken:
